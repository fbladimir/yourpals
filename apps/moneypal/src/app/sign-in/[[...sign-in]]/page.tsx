...
import { signInWithOAuth, signInWithEmail } from "../../../lib/auth-utils"
...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 relative overflow-hidden">
        {/* Enhanced Background */}
          ...
          <div className="max-w-lg text-center space-y-10">
            ...
            >
              ...
              <p className="text-xl text-gray-300 leading-relaxed">
                Track expenses, set goals, and get insights powered by artificial intelligence. 
              ...
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    Get real-time insights into your spending, savings goals, and financial health with our AI-powered analytics.
                  </p>
                </div>

...
export default function ComingSoon() {
  return (
    <section className="py-20 sm:py-24 md:py-28 lg:py-32 bg-gradient-to-b from-white/[0.05] via-purple-500/[0.03] to-blue-500/[0.05] relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 w-24 h-24 bg-cyan-500/10 rounded-full blur-2xl"></div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-400/30 text-sm text-purple-300 mb-6 backdrop-blur-sm"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-16">
          ...
          >
            <div className="bg-gradient-to-br from-blue-900/50 to-blue-800/30 border border-blue-700/50 rounded-3xl p-8 h-full hover:border-blue-600/70 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/20">
              {/* Glow Effect */}
          ...
          <motion.div
            ...
            className="group relative"
          >
            <div className="bg-gradient-to-br from-purple-900/50 to-purple-800/30 border border-purple-700/50 rounded-3xl p-8 h-full hover:border-purple-600/70 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/20">
              {/* Glow Effect */}

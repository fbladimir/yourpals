        ...
        <div className="relative rounded-3xl sm:rounded-[2rem] bg-gradient-to-r from-blue-500/20 via-cyan-500/20 to-teal-500/20 p-8 sm:p-12 lg:p-16 ring-1 ring-white/20 backdrop-blur-sm">
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6">
              ...
              <a 
                className="group relative inline-flex items-center justify-center px-8 sm:px-10 py-4 sm:py-5 rounded-2xl bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold text-lg sm:text-xl transition-all duration-300 shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 hover:scale-105 active:scale-95 overflow-hidden touch-manipulation"
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          <div className="grid gap-8 sm:gap-12 lg:grid-cols-3 lg:gap-16">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-base sm:text-lg text-white/70 leading-relaxed max-w-md mb-6 sm:mb-8">
                Your personal AI companions that help with finances, cooking, business, and daily tasks. Everything you need in one smart platform.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3 sm:space-y-4">
                <li>
                  <a href="/pricing" className="text-base sm:text-lg text-white/70 hover:text-white transition-colors duration-200 group">
                    <span className="group-hover:text-blueA transition-colors duration-200">Pricing</span>
                  </a>
                </li>
                <li>
                  <a href="/download" className="text-base sm:text-lg text-white/70 hover:text-white transition-colors duration-200 group">
                    <span className="group-hover:text-blueA transition-colors duration-200">Download</span>
                  </a>
                </li>
                <li>
                  <a href="/about" className="text-base sm:text-lg text-white/70 hover:text-white transition-colors duration-200 group">
                    <span className="group-hover:text-blueA transition-colors duration-200">About</span>
                  </a>
                </li>
                <li>
                  <a href="/contact" className="text-base sm:text-lg text-white/70 hover:text-white transition-colors duration-200 group">
                    <span className="group-hover:text-blueA transition-colors duration-200">Contact</span>
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 sm:space-y-4">
                <li>
                  <a href="/blog" className="text-base sm:text-lg text-white/70 hover:text-white transition-colors duration-200 group">
                    <span className="group-hover:text-cyan-500 transition-colors duration-200">Blog</span>
                  </a>
                </li>
                <li>
                  <a href="/privacy" className="text-base sm:text-lg text-white/70 hover:text-white transition-colors duration-200 group">
                    <span className="group-hover:text-cyan-500 transition-colors duration-200">Privacy</span>
                  </a>
                </li>
                <li>
                  <a href="/security" className="text-base sm:text-lg text-white/70 hover:text-white transition-colors duration-200 group">
                    <span className="group-hover:text-cyan-500 transition-colors duration-200">Security</span>
                  </a>
                </li>
                <li>
                  <a href="/terms" className="text-base sm:text-lg text-white/70 hover:text-white transition-colors duration-200 group">
                    <span className="group-hover:text-cyan-500 transition-colors duration-200">Terms</span>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="mt-12 sm:mt-16 md:mt-20 pt-8 sm:pt-12 border-t border-white/10">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-8">
              {/* Copyright */}
              <div className="text-sm sm:text-base text-white/50 flex items-center gap-2 text-center sm:text-left">
                <span className="w-1 h-1 bg-white/30 rounded-full"></span>
                © {currentYear} YourPals. All rights reserved.
              </div>
              
              {/* Additional Links */}
              <div className="flex items-center gap-4 sm:gap-6 lg:gap-8 text-sm sm:text-base">
                {/* Removed privacy, terms, and security links */}
              </div>
            </div>
          </div>
        </div>
